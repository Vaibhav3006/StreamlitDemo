...
def check_password(df,username,password):
    return df['Password'][df['Username']== username].iloc[0]
...
def main():
    ...
    if choice == "Home":
        ...
        if st.sidebar.checkbox("Login"):
            ...
            if pbkdf2_sha256.verify(password,check_password(user_df,username,password)):
